...
SECRET_KEY = '856!n_7&e8i8s3ysq8+ns72x*l=p8#r51%r*fjl3*=64u8=10k'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['aries.propulsion-learn.ch', 'localhost', '0.0.0.0', 'http://localhost:3000']
